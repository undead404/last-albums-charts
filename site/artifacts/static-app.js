...
var external_date_fns_ = __webpack_require__(7);

// EXTERNAL MODULE: external "filenamify"
var external_filenamify_ = __webpack_require__(26);
var external_filenamify_default = /*#__PURE__*/__webpack_require__.n(external_filenamify_);

// EXTERNAL MODULE: external "lodash/find"
var find_ = __webpack_require__(27);
var find_default = /*#__PURE__*/__webpack_require__.n(find_);

// EXTERNAL MODULE: external "lodash/map"
var map_ = __webpack_require__(28);
var map_default = /*#__PURE__*/__webpack_require__.n(map_);

// EXTERNAL MODULE: external "lodash/orderBy"
var orderBy_ = __webpack_require__(29);
...
// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/utils/deserialize-tag.ts
...
function deserializeTag(serializedTag) {
  return _objectSpread(_objectSpread({}, serializedTag), {}, {
    lastProcessedAt: serializedTag.lastProcessedAt ? Object(external_date_fns_["parseISO"])(serializedTag.lastProcessedAt) : null,
    listCreatedAt: serializedTag.listCreatedAt ? Object(external_date_fns_["parseISO"])(serializedTag.listCreatedAt) : null
  });
}
// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/utils/get-album-title.ts
function getAlbumTitle(album) {
  return "".concat(album.artist, " - ").concat(album.name, " (").concat(album.date, ")");
}
// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/pages/tags.tsx
...
function compareDates(d1, d2) {
  ...
  return Object(external_date_fns_["compareAsc"])(d1, d2);
}
...
function getPreviewFromTag(tag) {
  var albumWithCover = find_default()(orderBy_default()(tag.topAlbums, ['weight'], ['desc']), 'thumbnail');
  var imageUrl = albumWithCover ? albumWithCover.thumbnail : 'https://via.placeholder.com/450';
  return /*#__PURE__*/external_react_default.a.createElement(external_antd_["Tooltip"], {
    title: getAlbumTitle(albumWithCover)
  }, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Avatar"], {
    src: imageUrl
  }));
} // function renderListItem(tag: Tag) {
//   return (
//     <List.Item>
//       <List.Item.Meta
//         avatar={<Avatar src={getPreviewFromTag(tag)} />}
//         description={`Updated at: ${tag.listCreatedAt}`}
//         title={<Link to={`/tag/${filenamify(tag.name)}`}>{tag.name}</Link>}
//       />
//     </List.Item>
//   );
// }
...
var COLUMNS = [{
  key: 'number',
  render: function render(_value, _tag, index) {
    return "".concat(index + 1);
  },
  title: '#'
}, {
  key: 'name',
  render: function render(_value, tag) {
    return /*#__PURE__*/external_react_default.a.createElement(router_["Link"], {
      to: "/tag/".concat(external_filenamify_default()(tag.name))
    }, tag.name);
  },
  sorter: function sorter(tag1, tag2) {
  ...
  key: 'thumbnail',
  render: function render(_value, tag) {
    return getPreviewFromTag(tag);
  }
}, {
  key: 'listCreatedAt',
  render: function render(_value, tag) {
    return Object(external_date_fns_["formatISO"])(tag.listCreatedAt);
  },
  sorter: function sorter(tag1, tag2) {
  ...
  key: 'lastProcessedAt',
  render: function render(_value, tag) {
    return Object(external_date_fns_["formatISO"])(tag.lastProcessedAt);
  },
  sorter: function sorter(tag1, tag2) {
...
function TagPage() {
  var _useRouteData = Object(external_react_static_["useRouteData"])(),
      serializedTags = _useRouteData.tags;

  var tags = Object(external_react_["useMemo"])(function () {
    return map_default()(serializedTags, deserializeTag);
  }, [serializedTags]);
  return /*#__PURE__*/external_react_default.a.createElement(external_antd_["Layout"], null, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Layout"].Header, null, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Typography"].Title, null, "Available charts")), /*#__PURE__*/external_react_default.a.createElement(external_antd_["Layout"].Content, null, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Input"].Search, null), /*#__PURE__*/external_react_default.a.createElement(external_antd_["Table"], {
    columns: COLUMNS,
    dataSource: tags,
    rowKey: "name"
  })));
...
// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/components/FancyDiv.tsx

function FancyDiv(_ref) {
...
// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/containers/Dynamic.tsx

function Dynamic(properties) {
...
// EXTERNAL MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/app.css
var app = __webpack_require__(48);

// CONCATENATED MODULE: /Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/src/App.tsx
...
function App() {
  return /*#__PURE__*/external_react_default.a.createElement(external_react_static_["Root"], null, /*#__PURE__*/external_react_default.a.createElement(external_react_static_["Head"], null, /*#__PURE__*/external_react_default.a.createElement("link", {
    href: "https://img.discogs.com",
    rel: "preconnect"
  }), /*#__PURE__*/external_react_default.a.createElement("link", {
    href: "https://img.discogs.com",
    rel: "dns-prefetch"
  }), /*#__PURE__*/external_react_default.a.createElement("link", {
    href: "http://coverartarchive.org",
    rel: "preconnect"
  }), /*#__PURE__*/external_react_default.a.createElement("link", {
    href: "http://coverartarchive.org",
    rel: "dns-prefetch"
    ...
    className: "content"
  }, /*#__PURE__*/external_react_default.a.createElement(FancyDiv, null, /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Suspense, {
...
module.exports = require("/Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/node_modules/react-static/lib/browser");
...
function renderListItem(album, index) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["List"].Item, {
    extra: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["Image"], {
...
function Tags() {
  var _useRouteData = Object(react_static__WEBPACK_IMPORTED_MODULE_2__["useRouteData"])(),
      tag = _useRouteData.tag;

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["Layout"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["Layout"].Header, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["Typography"].Title, null, tag.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["Layout"].Content, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_0__["List"], {
...
var t_1 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/pages/about.tsx */).then(__webpack_require__.bind(null, 21))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
...
var t_3 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "__react_static_root__/src/pages/tags",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/pages/tags */).then(__webpack_require__.bind(null, 9))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '__react_static_root__/src/pages/tags');
  },
  resolve: function resolve() {
    return /*require.resolve*/(9);
  },
  chunkName: function chunkName() {
    return "__react_static_root__/src/pages/tags";
  }
}), universalOptions);
t_3.template = '__react_static_root__/src/pages/tags';
var t_4 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "__react_static_root__/src/pages/tags.tsx",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/pages/tags.tsx */).then(__webpack_require__.bind(null, 9))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '__react_static_root__/src/pages/tags.tsx');
  },
  resolve: function resolve() {
    return /*require.resolve*/(9);
  },
  chunkName: function chunkName() {
    return "__react_static_root__/src/pages/tags.tsx";
  }
}), universalOptions);
t_4.template = '__react_static_root__/src/pages/tags.tsx';
var t_5 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "__react_static_root__/src/pages/tag",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/pages/tag */).then(__webpack_require__.bind(null, 23))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '__react_static_root__/src/pages/tag');
  },
  resolve: function resolve() {
    return /*require.resolve*/(23);
  },
  chunkName: function chunkName() {
    return "__react_static_root__/src/pages/tag";
  }
}), universalOptions);
t_5.template = '__react_static_root__/src/pages/tag'; // Template Map
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  '__react_static_root__/src/pages/tags': t_3,
  '__react_static_root__/src/pages/tags.tsx': t_4,
  '__react_static_root__/src/pages/tag': t_5
}); // Not Found Template
...
module.exports = require("/Users/Vitalii_Perehonchuk/Projects/last-albums-charts/site/node_modules/react-static/lib/browser/hooks/useStaticInfo");
...
/* harmony import */ var antd_dist_antd_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(50);
